...
echo "TF_VAR_project=$(pass gcp_project)" > .env
echo "TF_VAR_email=$(pass gcp_email)" >> .env
echo "TF_VAR_credentials_file=$(pass gcp_credentials_file)" >> .env
echo "TF_VAR_notebooks_name=$(pass gcp_notebooks_name)" >> .env